...
export flamegraph, flamepixels, flametags, diffflamegraph, FlameColors, StackFrameCategory

include("graph.jl")
include("diffgraph.jl")
include("render.jl")
...
function _precompile_()
    ...
    if isdefined(Base, :bodyfunction)
        ...
        @assert precompile(f, (Dict{UInt64,Vector{Base.StackTraces.StackFrame}}, Bool, Bool, Symbol, Bool, Vector{Tuple{Symbol,Symbol}}, Nothing, typeof(flamegraph), Vector{UInt64}))
